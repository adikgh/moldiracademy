...
<? unset($_SESSION['loader']); ?>
   ...
   <div class="lbl1">
      ...
      <div class="bl_c">
         <div class="lbl1_c">
            <div class="lbl1_cm">
               <div class="lbl1_cmc">
                  <div class="lbl1_cmh">Мөлдір</div>
                  <div class="lbl1_cmp">қимыл қозғалыс <br> терапевті</div>
               </div>
               <div class="lbl1_cmc" id="top">
                  <a href="#top" class="btn btn_clm btn_dd lbl1_cm_btn"><i class="fal fa-long-arrow-down"></i></a>
                  <div class="lbl1_cmh lbl1_cmh2">Турымбет</div>
               </div>
            </div>
            ...
            <div class="lbl10_cm">
               <a class="lbl10_cml" target="_blank" href="/fitnessabi/">
                  ...
                  <div class="lbl10_cmlb">
                     <div class="lbl10_cmlbh">Fitnes Sabi 2.0</div>
               ...
               <a class="lbl10_cml" target="_blank" href="#">
                  ...
                  <div class="lbl10_cmlb">
                     <div class="lbl10_cmlbh">Мини курсы по диагнозам</div>
                     <div class="btn btn_dd btn_clm"><i class="fal fa-long-arrow-down"></i></div>
                  </div>
               </a>
            </div>
   ...
   <div class="lbl12">
      <div class="bl_c">
         ...
         <div class="lbl12_c">
            <a href="https://wa.me/77059014922" class="btn btn_whatsapp">
               <i class="fab fa-whatsapp"></i>
               <span>Whatsapp-ма жазу</span>
            </a>
            <a href="tel:87059014922" class="btn btn_clm">
               <i class="far fa-phone-alt"></i>
               <span>Қоңырау шалу</span>
            </a>
         </div>
