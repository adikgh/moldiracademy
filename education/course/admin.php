	...
	<div class="uitem">
		...
		<div class="uitem_c <?=(mysqli_num_rows($cblock) == 0?'uitem_c2':'')?>">
			...
			<div class="uitemc_l">
				...
				<? if (mysqli_num_rows($pack_all)): ?>
					<div class="uhwa_lp">
						<? $pack_all = db::query("select * from course_pack where course_id = '$course_id'"); ?>
						<? while($pack_d = mysqli_fetch_assoc($pack_all)): ?>
							<a class="uhwa_lpi <?=($pack_id == $pack_d['id']?'uhwa_lpi_act':'')?>" href="?id=<?=$course_id?>&pack_id=<?=$pack_d['id']?>">
								<span>Пакет:</span>
						...
						<div class="ucours_tm ucours_tm_btn">
							<button class="btn btn_k add_pack_b">
			...
			<div class="uc_list">
				...
				<? else: ?>
					<div class="coursls_i_rg">
						<div class="btn btn_k add_block_b">
							<i class="far fa-layer-plus"></i>
							<span>Бөлімдерге бөлу</span>
						</div>
					</div>
					<div class="coursls_i_rg">
						<div class="btn btn_k add_lesson_b">
							<i class="far fa-layer-plus"></i>
							<span>Жай сабақтарды қосу</span>
						</div>
					</div>
				<? endif ?>
			</div>
...
<? include "../block/footer.php"; ?>
	...
	<!-- pack add -->
	<div class="pop_bl pop_bl2 pack_add">
		<div class="pop_bl_a pack_add_back"></div>
		<div class="pop_bl_c">
			<div class="head_c txt_c">
				<h5>Пакет қосу</h5>
				<div class="btn btn_dd2 pack_add_back"><i class="fal fa-times"></i></div>
			</div>
			<div class="pop_bl_cl">
				<div class="form_c">
					<div class="form_im">
						<div class="form_span">Пакет атауы:</div>
						<input type="text" class="form_txt pack_name" placeholder="Атауын жазыңыз" data-lenght="2">
						<i class="far fa-text form_icon"></i>
					</div>
					<div class="form_im">
						<div class="form_span">Доступ уақыты (айды күндермен):</div>
						<input type="tel" class="form_txt fr_days pack_access" placeholder="60 күн" data-lenght="1" />
						<i class="fal fa-calendar-alt form_icon"></i>
					</div>
					<div class="form_im">
						<div class="form_span">Бағасы:</div>
						<input type="tel" class="form_im_txt fr_price pack_price" placeholder="10.000 тг" data-lenght="1" />
						<i class="fal fa-tenge form_icon"></i>
					</div>
					<div class="form_im">
						<div class="form_span">Жіңілдік бағасы:</div>
						<input type="tel" class="form_im_txt fr_price pack_price_sole" placeholder="10.000 тг" data-lenght="1" />
						<i class="fal fa-tenge form_icon"></i>
					</div>

					<div class="form_im form_im_bn">
						<div class="btn btn_pack_add" data-course-id="<?=$course_id?>">Қосу</div>
					</div>
				</div>
			</div>
		</div>
